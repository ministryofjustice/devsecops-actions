...
describe("execute", () => {
    ...
    it("should successfully scan three docker images", async () => {
        ...
        // Act
        await (0, scan_images_1.default)(mockValues);
        // Assert
        expect(console.info).toHaveBeenCalledTimes(5);
        expect(console.info).toHaveBeenCalledWith("✅ Successfully scanned %s", mockValues[0]);
        expect(console.info).toHaveBeenCalledWith("✅ Successfully scanned %s", mockValues[1]);
        expect(console.info).toHaveBeenCalledWith("✅ Successfully scanned %s", mockValues[2]);
        expect(console.info).toHaveBeenCalledWith("✅ Successfully scanned %s", mockValues[3]);
        expect(console.info).toHaveBeenCalledWith("\n\r\n\r✅ All %i images have been successfully scanned.", mockValues.length);
    });
    it("should throw an error for an invalid source type", async () => {
        ...
        // Act + Assert
        await expect((0, scan_images_1.default)(mockValues)).rejects.toThrow(mockError);
        // Assert
