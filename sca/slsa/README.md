  ...
  build:
    ...
    steps:
      ...
      - name: ⛓️ SLSA Supply Chain Security
        uses: ministryofjustice/devsecops-actions/sca/slsa@1cee8e5dce2be99328b2ea9074c7e0acdfd69907 # v1.4.0
...
```yaml
- name: ⛓️ SLSA Supply Chain Security
  uses: ministryofjustice/devsecops-actions/sca/slsa@1cee8e5dce2be99328b2ea9074c7e0acdfd69907
```
